...
<body>
		...
		<table>
			...
			<tr>
				<td><input type="text" name="StudID"
					value="<%=studCursObject.getStudent_id()%>"></td>
				<td><input type="text" name="CursID"
					value="<%=studCursObject.getCurs_id()%>"></td>
	...
	<%
		if ("POST".equalsIgnoreCase(request.getMethod())
			...
			studCursObject.setStud_curs_id(idStudCurs);
			studCursObject.setStudent_id(studId);
			studCursObject.setCurs_id(cursId);
